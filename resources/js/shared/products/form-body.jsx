...
import { Form, InputNumber, Button, Space, Flex } from "antd";
import { IconDeviceFloppy, IconMinus, IconCircleMinus, IconPlus } from "@tabler/icons-react";
...
const FormBody = (props) => {
    ...
    return (
        <Form form={form} onFinish={onFinish} autoComplete="off" layout="vertical">
            ...
            <Form.Item>
                <Button type="primary" htmlType="submit" icon={<IconDeviceFloppy/>} disabled={form.isFieldsTouched}>
